...
async function main() {
  ...
  const allPermissions: { roleId: string; resource: string; action: string }[] = [
    ...
    { roleId: managerRole.id, resource: 'tasks', action: 'manage' },
    { roleId: managerRole.id, resource: 'warehouses', action: 'read' },
    { roleId: staffRole.id, resource: 'tasks', action: 'read' },
    { roleId: staffRole.id, resource: 'tasks', action: 'update' },
    { roleId: staffRole.id, resource: 'scan', action: 'write' },
    ...
    { roleId: logisticsRole.id, resource: 'drivers', action: 'read' },
    { roleId: driverRole.id, resource: 'trips', action: 'read' },
    { roleId: driverRole.id, resource: 'orders', action: 'read' },
    { roleId: driverRole.id, resource: 'gps', action: 'write' },
