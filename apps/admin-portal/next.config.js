  ...
  async rewrites() {
    return [
      ...
      },
      {
        ...
        destination: 'http://127.0.0.1:3001/api/v1/admin/:path*'
      },
      {
        source: '/api/v1/tenant/:path*',
        destination: 'http://127.0.0.1:3001/api/v1/tenant/:path*'
      },
      {
        source: '/api/v1/iam/:path*',
        destination: 'http://127.0.0.1:3001/api/v1/iam/:path*'
      },
      {
        source: '/api/v1/users/:path*',
        destination: 'http://127.0.0.1:3001/api/v1/users/:path*'
      },
      {
        source: '/api/v1/roles/:path*',
        destination: 'http://127.0.0.1:3001/api/v1/roles/:path*'
      },
      {
        source: '/api/v1/feature-flags/:path*',
        destination: 'http://127.0.0.1:3001/api/v1/feature-flags/:path*'
      },
      {
        source: '/api/v1/api-keys/:path*',
        destination: 'http://127.0.0.1:3001/api/v1/api-keys/:path*'
      },
      {
        source: '/api/v1/billing/:path*',
        destination: 'http://127.0.0.1:3001/api/v1/billing/:path*'
      },
      {
        source: '/api/v1/auth/:path*',
        destination: 'http://127.0.0.1:3001/api/v1/auth/:path*'
      },
      {
        source: '/api/v1/metrics/:path*',
        destination: 'http://127.0.0.1:3001/api/v1/metrics/:path*'
      },
      {
        source: '/api/v1/notifications/:path*',
        destination: 'http://127.0.0.1:3005/api/v1/notifications/:path*'
      },
      {
        source: '/api/v1/public/:path*',
        destination: 'http://127.0.0.1:3006/api/v1/public/:path*'
      },
      {
        source: '/api/v1/client/:path*',
        destination: 'http://127.0.0.1:3006/api/v1/client/:path*'
      },
      {
